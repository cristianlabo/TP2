...
typedef enum
{
	Prefix_main_region_TITILA,
	Prefix_main_region_TITILA_r1_ENCENDIDO,
	Prefix_main_region_TITILA_r1_APAGADO,
	Prefix_main_region_REPOSO,
	Prefix_last_state
} PrefixStates;
...
typedef struct
{
	sc_boolean prefix_main_region_TITILA_r1_ENCENDIDO_tev0_raised;
	sc_boolean prefix_main_region_TITILA_r1_APAGADO_tev0_raised;
} PrefixTimeEvents;
