...
typedef enum
{
	...
	Prefix_eForma_MODO_1,
	Prefix_eForma_MODO_2,
	Prefix_eForma_MODO_3,
	Prefix_eMagn_ABIERTO,
	Prefix_eMagn_ABIERTO_r1_PUERTA_ABIERTA,
	Prefix_eMagn_CERRADO,
	Prefix_eMagn_CERRADO_r1_TERMINO,
	Prefix_eMagn_CERRADO_r1_COMENZO,
	Prefix_last_state
} PrefixStates;
...
typedef struct
{
	...
	sc_boolean eModoDeCoccion_raised;
	sc_boolean eProcesoCoccion_raised;
	sc_boolean eApertura_raised;
	sc_integer viTecla;
} PrefixInternal;
