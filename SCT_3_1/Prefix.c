...
sc_boolean prefix_isStateActive(const Prefix* handle, PrefixStates state)
{
	...
	switch (state)
	{
		...
		case Prefix_LED3_TITILA :
			result = (sc_boolean) (handle->stateConfVector[2] >= Prefix_LED3_TITILA
				&& handle->stateConfVector[2] <= Prefix_LED3_TITILA_r1_APAGADO);
			break;
		case Prefix_LED3_TITILA_r1_ENCENDIDO :
			result = (sc_boolean) (handle->stateConfVector[2] == Prefix_LED3_TITILA_r1_ENCENDIDO
			);
			break;
		case Prefix_LED3_TITILA_r1_APAGADO :
			result = (sc_boolean) (handle->stateConfVector[2] == Prefix_LED3_TITILA_r1_APAGADO
			);
			break;
		case Prefix_LED3_REPOSO :
			result = (sc_boolean) (handle->stateConfVector[2] == Prefix_LED3_REPOSO
			);
			break;
		default:
			result = bool_false;
...
static void prefix_enseq_LED3_TITILA_r1_ENCENDIDO_default(Prefix* handle)
{
	...
	handle->stateConfVector[2] = Prefix_LED3_TITILA_r1_ENCENDIDO;
...
static void prefix_enseq_LED3_REPOSO_default(Prefix* handle)
{
	...
	handle->stateConfVector[2] = Prefix_LED3_REPOSO;
	handle->stateConfVectorPosition = 2;
}
...
{
	/* Default exit sequence for region LED3 */
	/* Handle exit of all possible states (of prefix.LED3) at position 2... */
...
{
	/* Default exit sequence for region r1 */
	/* Handle exit of all possible states (of prefix.LED3.TITILA.r1) at position 2... */
	switch(handle->stateConfVector[ 2 ])
	{
		case Prefix_LED3_TITILA_r1_ENCENDIDO :
		{
