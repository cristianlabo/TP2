...
typedef enum
{
	...
	Prefix_eForma_velocidad_1,
	Prefix_eForma_velocidad_2,
	Prefix_INGRESO_EGRESO,
	Prefix_INGRESO_INGRESO,
	Prefix_last_state
} PrefixStates;
...
typedef struct
{
	...
	sc_boolean eVelocidad_raised;
	sc_boolean eIngreso_raised;
	sc_boolean eEgreso_raised;
	sc_integer viTecla;
} PrefixInternal;
